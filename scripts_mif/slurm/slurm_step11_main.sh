#!/bin/bash
#SBATCH -J step11_prolif
#SBATCH -p main
#SBATCH --cpus-per-task=20
#SBATCH --mem=64G
#SBATCH --time=01:00:00
#SBATCH --output=logs/step11-main-%j.out
#SBATCH --error=logs/step11-main-%j.err
...
conda run -p "$CONDA_ENV" python -u scripts/step11_proliferation_stratified_survival.py
