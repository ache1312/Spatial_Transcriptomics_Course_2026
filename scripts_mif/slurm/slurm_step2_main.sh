#!/bin/bash
#SBATCH -J step2_embeddings
#SBATCH -p main
#SBATCH --cpus-per-task=20
#SBATCH --mem=64G
#SBATCH --time=01:00:00
#SBATCH --output=logs/step2-main-%j.out
#SBATCH --error=logs/step2-main-%j.err
...
conda run -p "$CONDA_ENV" python -u scripts/step2_embeddings_and_qc.py
