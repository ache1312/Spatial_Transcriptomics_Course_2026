#!/bin/bash
#SBATCH -J step5_enrichment
#SBATCH -p labs
#SBATCH --cpus-per-task=15
#SBATCH --mem=32G
#SBATCH --time=02:00:00
#SBATCH --output=logs/step5-labs-%j.out
#SBATCH --error=logs/step5-labs-%j.err
...
conda run -p "$CONDA_ENV" python -u scripts/step5_enrichment.py
