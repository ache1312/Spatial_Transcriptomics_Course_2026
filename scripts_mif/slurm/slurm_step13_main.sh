#!/bin/bash
#SBATCH -J step13_lineage
#SBATCH -p main
#SBATCH --cpus-per-task=20
#SBATCH --mem=64G
#SBATCH --time=01:00:00
#SBATCH --output=logs/step13-main-%j.out
#SBATCH --error=logs/step13-main-%j.err
...
conda run -p "$CONDA_ENV" python -u scripts/step13_lineage_neighbors.py
