#!/bin/bash
#SBATCH -J step12_tcell
#SBATCH -p main
#SBATCH --cpus-per-task=20
#SBATCH --mem=64G
#SBATCH --time=01:00:00
#SBATCH --output=logs/step12-main-%j.out
#SBATCH --error=logs/step12-main-%j.err
...
conda run -p "$CONDA_ENV" python -u scripts/step12_tcell_clustering_analysis.py
