#!/bin/bash
#SBATCH -J step3_neighbors
#SBATCH -p labs
#SBATCH --cpus-per-task=15
#SBATCH --mem=32G
#SBATCH --time=01:00:00
#SBATCH --output=logs/step3-labs-%j.out
#SBATCH --error=logs/step3-labs-%j.err
...
conda run -p "$CONDA_ENV" python -u scripts/step3_neighbors.py
