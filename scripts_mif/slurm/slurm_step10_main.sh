#!/bin/bash
#SBATCH -J step10_mixing
#SBATCH -p main
#SBATCH --cpus-per-task=20
#SBATCH --mem=64G
#SBATCH --time=01:00:00
#SBATCH --output=logs/step10-main-%j.out
#SBATCH --error=logs/step10-main-%j.err
...
conda run -p "$CONDA_ENV" python -u scripts/step10_mixing_score.py
