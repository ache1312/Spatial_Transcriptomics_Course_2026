#!/bin/bash
#SBATCH -J step7_dispersion
#SBATCH -p main
#SBATCH --cpus-per-task=20
#SBATCH --mem=64G
#SBATCH --time=01:00:00
#SBATCH --output=logs/step7-main-%j.out
#SBATCH --error=logs/step7-main-%j.err
...
conda run -p "$CONDA_ENV" python -u scripts/step7_dispersion.py
