...
#SBATCH -c 20
#SBATCH --mem=42G
#SBATCH --mail-user=xxxxxx@xxxxx.xx
...
REPORT_FILE="${REPORT_DIR}/4_visium_RCTD_Annotation_DE_V7_${SLURM_JOB_ID}.log"
...
#--------------- Run R + capture console + time --------
{
  ...
  Rscript $HOME/scripts_visium/4_visium_RCTD_Annotation_DE_V7.R "$PLOT_DIR"
  rstatus=$?
