#!/bin/bash
#---------------Script SBATCH - NLHPC ----------------
#SBATCH -J visium_subset
#SBATCH -p main
#SBATCH -n 1
#SBATCH -c 1
#SBATCH --mem=42G
#SBATCH --time=24:00:00
#SBATCH --mail-user=xxxxx@xxxxxx.xx
...
REPORT_FILE="${REPORT_DIR}/2_visium_subset_report_${SLURM_JOB_ID}.log"
...
#--------------- Run R + capture console + time --------
{
  ...
  Rscript $HOME/scripts_visium/2_visium_subset.R "$PLOT_DIR"
  rstatus=$?
