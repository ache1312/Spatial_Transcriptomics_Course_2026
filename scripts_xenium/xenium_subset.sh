...
REPORT_FILE="${REPORT_DIR}/xenium_subset_report_${SLURM_JOB_ID}.log"
...
#--------------- Run R + capture console + time --------
{
  ...
  Rscript /home/courses/student75/xenium_subset.R "$PLOT_DIR"
  rstatus=$?
