#!/bin/bash
#---------------Script SBATCH - NLHPC ----------------
#SBATCH -J xenium_colocalization
#SBATCH -p labs
#SBATCH -n 1
#SBATCH -c 1
#SBATCH --mem=42G
...
REPORT_FILE="${REPORT_DIR}/xenium_colocalization_report_${SLURM_JOB_ID}.log"
...
{
  echo "========== Xenium Co-localization report =========="
  ...
  Rscript /home/courses/student75/xenium_colocalization.R "$PLOT_DIR"
  rstatus=$?
