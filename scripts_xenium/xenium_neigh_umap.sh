...
REPORT_FILE="${REPORT_DIR}/xenium_neigh_umap_report_${SLURM_JOB_ID}.log"
...
{
  echo "========== Xenium Neighbors to UMAP report =========="
  ...
  Rscript /home/courses/student75/xenium_neigh_umap.R "$PLOT_DIR"
  rstatus=$?
