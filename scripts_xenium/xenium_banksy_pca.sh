...
REPORT_FILE="${REPORT_DIR}/xenium_banksy_pca${SLURM_JOB_ID}.log"
...
{
  echo "========== Xenium Banksy to PCA report =========="
  ...
  Rscript /home/courses/student75/xenium_banksy_pca.R "$PLOT_DIR"
  rstatus=$?
