...
REPORT_FILE="${REPORT_DIR}/xenium_annot_deconv_${SLURM_JOB_ID}.log"
...
{
  echo "========== Xenium Annotation-Deconvolution report =========="
  ...
  Rscript /home/courses/student75/xenium_annot_deconv.R "$PLOT_DIR"
  rstatus=$?
