...
REPORT_FILE="${REPORT_DIR}/xenium_norm_pca_report_${SLURM_JOB_ID}.log"
...
{
  echo "========== Xenium Normalization to PCA report =========="
  ...
  Rscript /home/courses/student75/xenium_norm_pca.R "$PLOT_DIR"
  rstatus=$?
